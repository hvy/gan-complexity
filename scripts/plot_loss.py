...
def parse_args():
    ...
    parser.add_argument('--log', type=str, default='result/logs/loss')
    parser.add_argument('--out', type=str, default='result/plot_loss.png')
    parser.add_argument('--keys', nargs='+', type=str, default=['dis/loss', 'gen/loss'])
